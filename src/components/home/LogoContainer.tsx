    ...
    <div className=" px-4 pt-2 pb-6 flex items-center gap-6 justify-center">
      <div className="hover:mx-3 hover:border-[#11100f] hover:px-6 duration-500 border border-[#0f0f0e] flex items-center gap-3 bg-[#161513] text-[#878A8E] rounded-md py-[9px] px-4 cursor-pointer">
        ...
        <div className="">
          ...
          <p className=" text-xs font-medium -mt-0.5 font-Roboto">See my work</p>
        </div>
      </div>
      <div className="hover:mx-3 hover:border-[#11100f] hover:px-6 duration-500 border border-[#0f0f0e] flex items-center gap-3 bg-[#161513] text-[#878A8E] rounded-md py-[9px] px-4 cursor-pointer">
        ...
        <div className="">
          ...
          <p className=" text-xs font-medium -mt-0.5 font-Roboto">See my story</p>
        </div>
      </div>
      <div className="hover:mx-3 hover:border-[#11100f] hover:px-6 duration-500 border border-[#0f0f0e] flex items-center gap-3 bg-[#161513] text-[#878A8E] rounded-md py-[9px] px-4 cursor-pointer">
        ...
        <div className="">
          ...
          <p className=" text-xs font-medium -mt-0.5 font-Roboto">See my photo</p>
        </div>
      </div>
      <div className="hover:mx-3 hover:border-[#11100f] hover:px-6 duration-500 border border-[#0f0f0e] flex items-center gap-3 bg-[#161513] text-[#878A8E] rounded-md py-[9px] px-4 cursor-pointer">
        ...
        <div className="">
          ...
          <p className=" text-xs font-medium -mt-0.5 font-Roboto">See my thoughts</p>
        </div>
      </div>
    </div>
  );
